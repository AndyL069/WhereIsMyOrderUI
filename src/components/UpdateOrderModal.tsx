...
<Form onSubmit={props.handleUpdateSubmit}>
    ...
    <ModalBody>
        ...
        <FormGroup>
            ...
            <Input type="date" name="orderArrivalDate" id="orderArrivalDate" value={new Date(props.orderArrivalDate).toString()} onChange={(event) => props.setOrderArrivalDate(event.currentTarget.value)} />
        </FormGroup>
        <FormGroup>
